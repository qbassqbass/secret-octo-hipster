...
--
-- Host: localhost
-- Czas wygenerowania: 12 Cze 2014, 00:23
...
(1, 'Dummy Attraction', 2.5),
(2, 'Dummy Attraction 2', 3.75);
...
(2, 'Matrix', 'Action', 'everyone', 'Blablubel'),
(3, 'LOTR', 'Fantasy', 'Adult', 'Hello World!');
...
--
-- Struktura tabeli dla tabeli `ReportData`
--
...
--
-- Zrzut danych tabeli `ReportData`
--

INSERT INTO `ReportData` (`id`, `userId`, `type`, `timestamp`, `reference`) VALUES
(1, 1, 2, '3914-07-11 23:30:00', 1),
(2, 1, 2, '2014-06-11 23:18:02', 1);
...
(4, 'Dummy Dummy', 4, '2:3,2:4,2:5,2:6', NULL, NULL),
(5, 'Adam Odrobina', 4, '1:1,1:2,1:3', NULL, NULL);
...
--
-- Ograniczenia dla tabeli `ReportData`
--
ALTER TABLE `ReportData`
  ADD CONSTRAINT `ReportData_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `Users` (`id`);
