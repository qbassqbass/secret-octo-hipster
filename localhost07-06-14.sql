...
(1, 'Kolejka górska', 10.5),
(2, 'Karuzela samolotowa', 8.75);
(3, 'Odwrócony dom', 6,8);
(4, 'Zeœlizg czteroko³owy', 7,3);
(5, 'Skakañce', 7,5);
(6, 'Basen z ³ódkami', 4,9);
(7, 'Loteria', 4,5);
...
(2, 'By³a sobie rodzinka', 'Horror', '18+', 'Na polu z truskawkami bawi³y siê dzieci. Wtedy jeszcze nie wiedzia³y czym to grozi...');
(3, 'Biedroneczki s¹ w kropeczki', 'Animowany', '7+', 'Animowany œwiat ukazuj¹cy codzienne ¿ycie ma³ych biedroneczek.'),
(4, 'Przygody puchatego misia ', 'Animowany', '7+', 'Puchaty miœ razem ze swoimi przyjació³mi wybiera siê na ognisko, a tu nagle...');
(5, 'Wœciek³e koty', 'Thriller', '12+', 'Dwóch mê¿czyzn znudzonych rutyn¹ zak³ada klub, w którym co tydzieñ odbywaj¹ siê walki na go³e piêœci. '),
(6, 'Osiem', 'Thriller', '12+', 'Dziennikarz oskar¿ony o znies³awienie otrzymuje zlecenie zbadania zaginiêcia przed 40 laty 8 kobiet. ');
(7, 'Pawe³ i Maciek', 'Kryminalny', '15+', 'Bohaterowie bior¹ udzia³ w zawodach w bryd¿a. Stawka staje siê ogromna, gdy w grê wchodzi ¿ycie.'),
(8, 'Wampir', 'Kryminalny', '15+', 'W centrum miasta powstaje zoo z egzotycznymi zwierzêtami. Gdy zaczynaj¹ gin¹æ m³odzi ludzie rozpoczynaj¹ siê podejrzenia. ');
...
(9, 'Józef £adny', 7, '7:3,7:4,7:5,7:6', NULL, NULL);
